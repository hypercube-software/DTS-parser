...
- [DTS-parser](#dts-parser)
  - [Introduction](#introduction)
  - [DTS streams](#dts-streams)
  - [A generic bitstream parser](#a-generic-bitstream-parser)
    - [DTS WAV](#dts-wav)
    - [Regular DTS](#regular-dts)
    - [End of stream](#end-of-stream)
  - [The DTS parser](#the-dts-parser)
  - [A generic bitstream writer](#a-generic-bitstream-writer)
